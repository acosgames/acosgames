...
async function executeNodeScript(scriptPath, url) {
...
async function openBrowser(url) {
    // console.log("TRYING TO FIND BROWSERENV");
    const { action, value, args } = await getBrowserEnv();
    // console.log("BROWSERENV:", action, value, args);
    switch (action) {
        case Actions.NONE:
